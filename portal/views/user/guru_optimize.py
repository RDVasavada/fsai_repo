...
#   ########################
#   # Screen for all snapshots
#   ########################

#   # Set list of stocks and filters
#   quandl.ApiConfig.api_key = 'X8CjGKTPEqTuto2v_Q94'
...
#   # get screen criteria from screening table and build screen conditions
...
#   ############################################
#   # PORTFOLIO REALLOCATION FOR ALL SNAPSHOTS #
#   ############################################
...
#       pf, screen, pf_ret = Portfolio_Reallocation(pf_input, m,min_factor,max_factor)
...
# def Portfolio_Reallocation(portfolio_input, j, min_factor, max_factor):
