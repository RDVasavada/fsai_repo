...
# Tas-MacBook-Pro:reacttest ta$ mysql -u root -p fsai -e "ALTER TABLE portal_portfolio MODIFY investing_amount varchar(255) not null"
# Enter password:
# Tas-MacBook-Pro:reacttest ta$ mysql -u root -p fsai -e "ALTER TABLE portal_portfolio MODIFY num_stocks  varchar(255) not null"
# Enter password:
# Tas-MacBook-Pro:reacttest ta$ mysql -u root -p fsai -e "ALTER TABLE portal_stock MODIFY number_of_shares  varchar(255) not null"
# mysql -u root -p fsai -e "ALTER TABLE portal_stock ADD COLUMN sentiment varchar(25) not null"