	    ...
	    render: function () {
	        if (this.state.data) {
	            var bookNodes = this.state.data.map(function (x, i) {
	                console.log(x.texts[i]);
	                // return <li> {book.message} </li>
	            });
	        }
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                'powered by ',
	                React.createElement('img', { src: 'https://www.glassdoor.com/static/img/api/glassdoor_logo_80.png', title: 'Job Search' })
	            ),
	            React.createElement(
	                'h1',
	                null,
