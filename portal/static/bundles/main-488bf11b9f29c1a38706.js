	                                            ...
	                                            var starMe = function (id) {
	                                                $.ajax({
	                                                    ...
	                                                    if (String(res.data) == 'star') {
	                                                        var starid = "star" + id;
	                                                        ReactDOM.render(React.createElement(FaStar, { style: iconStar }), document.getElementById(starid));
	                                                    } else {
	                                                        var starid = "star" + id;
	                                                        ReactDOM.render(React.createElement(FaStarO, { style: iconStar }), document.getElementById(starid));
	                                                    }
	                                                });
	                                            };
