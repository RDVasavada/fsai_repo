	                                            ...
	                                            var starMe = function (id) {
	                                                $.ajax({
	                                                    ...
	                                                    if (String(res.data) == 'star') {
	                                                        var starid = "star" + id;
	                                                        $("div#" + starid)[0].innerHTML = ReactDOM.render(React.createElement(FaStar, null), document.getElementById(starid));
	                                                        console.log("asdf");
	                                                    } else {
	                                                        var starid = "star" + id;
	                                                        //     $("#"+starid)[0].innerHTML = <FaStarO  id={starid} style={iconStar} />
	                                                    }
	                                                });
	                                            };
