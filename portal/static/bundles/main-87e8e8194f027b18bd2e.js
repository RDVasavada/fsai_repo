...
/***/ function(module, exports, __webpack_require__) {
	...
	var BooksList = React.createClass({
	    ...
	    loadBooksFromServer: function () {
	        $.ajax({
	            ...
	            success: function (data) {
	                // console.log(data)
	                // var newData = this.state.data.concat([data])[0].texts;  
	    ...
	    render: function () {
	        console.log(this.state.data.texts);
	        if (this.state.data.texts.length > 0) {
