	            ...
	            if (a == '-1') {
	                var accept = function () {
	                    ...
	                    $.ajax({
	                        ...
	                        var str = "#a" + String(c);
	                        $(str)[0].innerHtml = "<span class='icon-trash'></span>" + b[0][0].username + "<i class='icon-angle-right pull-right'></i><i id='emptystar' style='margin-right:5px' class='icon-star-empty pull-right'></i>";
	                        // setTimeout(function(){ 
