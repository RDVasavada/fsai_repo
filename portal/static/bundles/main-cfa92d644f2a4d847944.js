...
/***/ function(module, exports, __webpack_require__) {
	                ...
	                if (x.status == 1) {
	                    return React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: '#', onClick: () => {
	                                    select(x.id, x.status, x.username, x.phone, x.firmname);
	                                }, style: onlineicon },
	                            ' a'
	                        ),
	                        React.createElement(
	...
	var select = function (id, status, username, phone, firmname) {
	    ...
	    $("#selected_user")[0].innerHTML = "<span style='font-size:24px'>" + String(username) + "</span><br><span style='margin-left:10px'>" + String(firmname) + "</span>";
	};
