	...
	var BooksList = React.createClass({
	    ...
	    render: function () {
	        if (this.state.data) {
	            ...
	            var bookNodes = this.state.data.map(function (x, i) {
	                return React.createElement(
	                    'li',
	                    null,
	                    x.texts[x.length - 1].id,
	                    ' | ',
	                    x.texts[x.length - 1].phone_number,
	                    ' | ',
	                    x.texts[x.length - 1].user_id,
	                    ' | ',
	                    x.texts[x.length - 1].message,
	                    ' | ',
	                    x.texts[x.length - 1].analysis,
	                    ' | ',
	                    x.texts[x.length - 1].resolution
	                );
	            });
	        }
	        return React.createElement(
