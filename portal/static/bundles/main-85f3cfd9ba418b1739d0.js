...
/***/ function(module, exports, __webpack_require__) {
	...
	var MSGList = React.createClass({
	    ...
	    loadMessagesFromServer: function () {
	        ...
	        var user = JSON.parse(localStorage.getItem('user')).user.slice(0, 10);
	        console.log(user);
	        $.ajax({
	            url: "/user/getmsg",
	            datatype: 'json',
	            type: 'GET',
	            data: { 'selected': chosen, 'category': category, 'phone': number, 'user': user },
	            cache: false,
	            success: function (data) {
	                console.log(data);
	                if (status == "newfriend") {
	                                    ...
	                                    if (x[0].content) {
	                                        ...
	                                        if (writer == you) {
	                                            ...
	                                            return React.createElement(
	                                                ...
	                                                React.createElement('img', { src: '/static/img/profile.svg', style: imgStyle }),
	                                                React.createElement(
	                                                    'div',
	                                                    { style: style },
	                                                    str
	            ...
	            var texts = a.map(function (x, i) {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: '#', onClick: () => {
	                                select(x.id, x.status, x.username, x.phone);
	                            }, style: linkStyle },
	                        x.username
	                    )
	                );
