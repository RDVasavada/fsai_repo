	                                        ...
	                                        if (writer == you) {
	                                            ...
	                                            if (lastmsg === 0 || lastmsg === -1) {
	                                                ...
	                                                return React.createElement(
	                                                    'div',
	                                                    { style: boxStyle },
	                                                    React.createElement('img', { src: YourPictureUrl, style: imgStyle }),
	                                                    React.createElement(
	                                                        'span',
	                                                        { style: spanRight },
	                                                        you
	                                            ...
	                                            var arrowStyle = {
	                                                ...
	                                                borderRightRolor: 'rgba(0, 0, 0, 0.2)',
	                                                borderWidth: '6px',
	                                                top: '14px',
	                                                right: '100%',
	        ...
	        if (this.state.data) {
	            ...
	            var texts = a.map(function (x, i) {
	                ...
	                return React.createElement(
	                    'div',
	                    { style: divStyle },
	                    React.createElement('img', { src: x.picture_url, style: imgStyle }),
	                    React.createElement(
	                        'a',
	                        { href: '#', onClick: () => {
	                                select(x.id, x.status, x.username, x.picture_url);
	                            }, style: linkStyle },
	                        x.username
	                    )
	                );
