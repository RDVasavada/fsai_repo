	    ...
	    render: function () {
	        if (this.state.data) {
	            ...
	            if (a == '-1') {
	                ...
	                lastmsg = 0;
	                if (b.length === 1) {
	                    var chosen = JSON.parse(localStorage.getItem('user')).username;
	                    var style = {
	                        fontWeight: '100',
	                    ...
	                    return React.createElement(
	                        'h2',
	                        { style: style },
	                        'This is the beginning of a direct messaging conversation between you and ',
	                        chosen,
	                        '.',
	            ...
	            var texts = a.map(function (x, i) {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: '#', onClick: () => {
	                                select(x.id, x.status, x.username);
	                            }, style: linkStyle },
	                        x.username
	                    )
	                );
