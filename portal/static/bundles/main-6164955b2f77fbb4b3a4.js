...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaBeer = __webpack_require__(160);
	                                    ...
	                                    if (x[0].content) {
	                                        ...
	                                        if (writer == you) {
	                                            ...
	                                            return React.createElement(
	                                                ...
	                                                React.createElement(
	                                                    'div',
	                                                    { style: style, 'class': 'messages-item-text' },
	                                                    str
	                                                )
	                                            );
	                                        }
	        ...
	        if (this.state.data) {
	            var select = function (id, status) {
	                if (status == 'New Friend Request') {
	                    ...
	                    var all = $("a#selected");
	                    $("#selected")[0].value = String(id);
	                    $("#selectedId")[0].value = String(id);
	            ...
	            var texts = a.map(function (x, i) {
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: '#', onClick: select(x.id, x.status), style: linkStyle },
	                        x.username
	                    ),
	                    React.createElement(FaBeer, null)
	                );
	            });
	        }
	        return React.createElement(
