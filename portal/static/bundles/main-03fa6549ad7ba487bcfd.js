	        ...
	        if (this.state.data) {
	            ...
	            if (a == '-1') {
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'form',
	                        { action: '/user/accept', method: 'post' },
	                        React.createElement(
	                            'button',
	                            { type: 'submit', name: 'acceptid', value: this.state.chosen_id },
	                            'Submit'
	                        )
	                    )
	                );
	                ...
	                var messages = b.map(function (x, i) {
	                    ...
	                    if (x[0].content == "blank") {
	                        ...
	                        return React.createElement(
	                            ...
	                            ' ',
	                            x[0].username,
	                            ' has just accepted your friend request! '
	                        );
	                    }
	                });
	            }
	            // console.log(String(a[0]) == "-1")
	            // if (String(a[0]) == '-1') {
	            //     console.log("qwerqsdf")
	            // }
