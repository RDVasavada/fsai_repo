...
/***/ function(module, exports, __webpack_require__) {
	                                        ...
	                                        if (writer == you) {
	                                            ...
	                                            var starMe = function (id) {
	                                                $.ajax({
	                                                    ...
	                                                    if (String(res.data) == 'star') {
	                                                        var starid = "star" + id;
	                                                        ReactDOM.render(React.createElement(FaStar, { id: starid, style: iconStar }), document.getElementById(starid));
	                                                    } else {
	                                                        var starid = "star" + id;
	                                                        ReactDOM.render(React.createElement(FaStarO, { id: starid, style: iconStar }), document.getElementById(starid));
	                                                    }
	                                                });
	                                            };
	                                            ...
	                                            return React.createElement(
	                                                ...
	                                                React.createElement(
	                                                    ...
	                                                    { style: spanRight },
	                                                    you,
	                                                    React.createElement(FaTrash, { onClick: () => {
	                                                            delMe(x[0].id);
	                                                        }, style: iconDel }),
	                                            ...
	                                            var starMe = function (id) {
	                                                $("#" + starid)[0].innerHTML = React.createElement(FaStar, { id: starid, style: iconStar });
	                                            };
	                                            return React.createElement(
	                                                'div',
	                                                null,
	...
	if (url.indexOf("inbox") > 0) {
	    ...
	    ReactDOM.render(React.createElement(StarredList, { pollInterval: 1000 }), document.getElementById('mcontainer'));
	    ReactDOM.render(React.createElement(ContactList, { pollInterval: 1000 }), document.getElementById('acontainer'));
	} else if (url.indexOf("deleted") > 0) {
	    ReactDOM.render(React.createElement(DelList, { pollInterval: 1000 }), document.getElementById('mcontainer'));
	    ReactDOM.render(React.createElement(ContactList, { pollInterval: 1000 }), document.getElementById('acontainer'));
